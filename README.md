...
```
- src: http://github.com/idealista-tech/prometheus_node_exporter-role.git
  scm: git
  version: 1.0.0
...
For the versions available, see the [tags on this repository](https://github.com/idealista-tech/prometheus_node_exporter-role/tags).
...
See also the list of [contributors](https://github.com/idealista-tech/prometheus_node_exporter-role/contributors) who participated in this project.
